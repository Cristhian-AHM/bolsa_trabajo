...
@section('title','Gestión de experiencia de trabajo')
@section('styles')
<style type="text/css">
    .unstyled-button {
        border: none;
    ...
    <div class="page-header">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-custom">
                ...
                <li class="breadcrumb-item active" aria-current="page">Experiencia de trabajo</li>
            </ol>
        </nav>
    </div>
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title">Experiencia de trabajo</h4>
