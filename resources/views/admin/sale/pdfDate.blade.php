            ...
            <table id="facproducto">
                ...
                <tbody>
                    @foreach ($saleDetails as $saleDetail)
                        <tr>
                            <td style="text-align:center">{{$saleDetail->quantity}} uds.</td>
                            <td style="text-align:center">{{$saleDetail->product_name}}</td>
                            <td style="text-align:center">{{number_format($saleDetail->price,2)}}$</td>
                            <td style="text-align:center">{{$saleDetail->discount}}</td>
                            <td style="text-align:center">{{number_format($saleDetail->quantity*$saleDetail->price - $saleDetail->quantity*$saleDetail->price*$saleDetail->discount/100,2)  }}$
                            </td>
                        </tr>
                    @endforeach
                </tbody>
