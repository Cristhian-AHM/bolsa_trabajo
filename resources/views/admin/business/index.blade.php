        ...
        <div class="col-lg-12 grid-margin stretch-card">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <p class="text-muted mt-2" style="font-size:20px;">
                        {{$business->name}}
                    </p>
                    <hr>
                ...
                <div class="form-group col-md-6">
                    ...
                    <p class="text-muted mt-2" style="font-size:20px;">{{$business->mail}}</p>
                    <hr>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <img style="width:200px ; height:200px ;" src="{{asset('image/'.$business->logo)}}"
